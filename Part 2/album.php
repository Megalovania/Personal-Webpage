...
This page contains a dynamic photo album
      ...
      <div class="col-sm-8 text-left" id="album">
        ...
        <div class="img">
          <a target="_blank" href="b-images/<?php echo($filename); ?>">         
            <div class="trim"><img src="b-images/<?php echo($filename); ?>" alt="<?php echo($bfilename[0]); ?>"></div>           <!--make a div tag specify image name as background-image, background size | position-->
          </a>
